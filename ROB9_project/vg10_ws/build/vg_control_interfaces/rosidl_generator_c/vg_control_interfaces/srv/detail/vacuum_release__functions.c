...
vg_control_interfaces__srv__VacuumRelease_Request__are_equal(const vg_control_interfaces__srv__VacuumRelease_Request * lhs, const vg_control_interfaces__srv__VacuumRelease_Request * rhs)
{
  ...
  // release_vacuum
  if (lhs->release_vacuum != rhs->release_vacuum) {
    return false;
  }
  return true;
}
  ...
  vg_control_interfaces__srv__VacuumRelease_Request * output)
{
  ...
  // release_vacuum
  output->release_vacuum = input->release_vacuum;
  return true;
}
...
vg_control_interfaces__srv__VacuumRelease_Request__create()
{
  ...
  vg_control_interfaces__srv__VacuumRelease_Request * msg = (vg_control_interfaces__srv__VacuumRelease_Request *)allocator.allocate(sizeof(vg_control_interfaces__srv__VacuumRelease_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vg_control_interfaces__srv__VacuumRelease_Request));
  bool success = vg_control_interfaces__srv__VacuumRelease_Request__init(msg);
  if (!success) {
...
vg_control_interfaces__srv__VacuumRelease_Request__destroy(vg_control_interfaces__srv__VacuumRelease_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    vg_control_interfaces__srv__VacuumRelease_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
vg_control_interfaces__srv__VacuumRelease_Request__Sequence__init(vg_control_interfaces__srv__VacuumRelease_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vg_control_interfaces__srv__VacuumRelease_Request * data = NULL;

  if (size) {
    data = (vg_control_interfaces__srv__VacuumRelease_Request *)allocator.zero_allocate(size, sizeof(vg_control_interfaces__srv__VacuumRelease_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vg_control_interfaces__srv__VacuumRelease_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        vg_control_interfaces__srv__VacuumRelease_Request__fini(&data[i - 1]);
      }
...
vg_control_interfaces__srv__VacuumRelease_Request__Sequence__fini(vg_control_interfaces__srv__VacuumRelease_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      vg_control_interfaces__srv__VacuumRelease_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vg_control_interfaces__srv__VacuumRelease_Request__Sequence * array = (vg_control_interfaces__srv__VacuumRelease_Request__Sequence *)allocator.allocate(sizeof(vg_control_interfaces__srv__VacuumRelease_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vg_control_interfaces__srv__VacuumRelease_Request__Sequence__init(array, size);
  if (!success) {
...
vg_control_interfaces__srv__VacuumRelease_Request__Sequence__destroy(vg_control_interfaces__srv__VacuumRelease_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vg_control_interfaces__srv__VacuumRelease_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vg_control_interfaces__srv__VacuumRelease_Request__Sequence__are_equal(const vg_control_interfaces__srv__VacuumRelease_Request__Sequence * lhs, const vg_control_interfaces__srv__VacuumRelease_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vg_control_interfaces__srv__VacuumRelease_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vg_control_interfaces__srv__VacuumRelease_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vg_control_interfaces__srv__VacuumRelease_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vg_control_interfaces__srv__VacuumRelease_Request * data =
      (vg_control_interfaces__srv__VacuumRelease_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vg_control_interfaces__srv__VacuumRelease_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vg_control_interfaces__srv__VacuumRelease_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!vg_control_interfaces__srv__VacuumRelease_Request__copy(
...
vg_control_interfaces__srv__VacuumRelease_Response__init(vg_control_interfaces__srv__VacuumRelease_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    vg_control_interfaces__srv__VacuumRelease_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vg_control_interfaces__srv__VacuumRelease_Response * msg = (vg_control_interfaces__srv__VacuumRelease_Response *)allocator.allocate(sizeof(vg_control_interfaces__srv__VacuumRelease_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vg_control_interfaces__srv__VacuumRelease_Response));
  bool success = vg_control_interfaces__srv__VacuumRelease_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
vg_control_interfaces__srv__VacuumRelease_Response__Sequence__init(vg_control_interfaces__srv__VacuumRelease_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vg_control_interfaces__srv__VacuumRelease_Response * data = NULL;

  if (size) {
    data = (vg_control_interfaces__srv__VacuumRelease_Response *)allocator.zero_allocate(size, sizeof(vg_control_interfaces__srv__VacuumRelease_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vg_control_interfaces__srv__VacuumRelease_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        vg_control_interfaces__srv__VacuumRelease_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
vg_control_interfaces__srv__VacuumRelease_Response__Sequence__fini(vg_control_interfaces__srv__VacuumRelease_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      vg_control_interfaces__srv__VacuumRelease_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vg_control_interfaces__srv__VacuumRelease_Response__Sequence * array = (vg_control_interfaces__srv__VacuumRelease_Response__Sequence *)allocator.allocate(sizeof(vg_control_interfaces__srv__VacuumRelease_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vg_control_interfaces__srv__VacuumRelease_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
vg_control_interfaces__srv__VacuumRelease_Response__Sequence__destroy(vg_control_interfaces__srv__VacuumRelease_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vg_control_interfaces__srv__VacuumRelease_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vg_control_interfaces__srv__VacuumRelease_Response__Sequence__are_equal(const vg_control_interfaces__srv__VacuumRelease_Response__Sequence * lhs, const vg_control_interfaces__srv__VacuumRelease_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vg_control_interfaces__srv__VacuumRelease_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vg_control_interfaces__srv__VacuumRelease_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vg_control_interfaces__srv__VacuumRelease_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vg_control_interfaces__srv__VacuumRelease_Response * data =
      (vg_control_interfaces__srv__VacuumRelease_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vg_control_interfaces__srv__VacuumRelease_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vg_control_interfaces__srv__VacuumRelease_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!vg_control_interfaces__srv__VacuumRelease_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
