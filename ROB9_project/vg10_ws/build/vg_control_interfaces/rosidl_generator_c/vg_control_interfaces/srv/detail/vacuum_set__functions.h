...
#ifndef VG_CONTROL_INTERFACES__SRV__DETAIL__VACUUM_SET__FUNCTIONS_H_
#define VG_CONTROL_INTERFACES__SRV__DETAIL__VACUUM_SET__FUNCTIONS_H_
...
/// Initialize srv/VacuumSet message.
/**
...
/// Finalize srv/VacuumSet message.
/**
...
/// Create srv/VacuumSet message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vg_control_interfaces__srv__VacuumSet_Request__init().
...
/// Destroy srv/VacuumSet message.
/**
 * It calls
 * vg_control_interfaces__srv__VacuumSet_Request__fini()
...
/// Check for srv/VacuumSet message equality.
/**
...
/// Initialize array of srv/VacuumSet messages.
/**
...
/// Finalize array of srv/VacuumSet messages.
/**
 * It calls
 * vg_control_interfaces__srv__VacuumSet_Request__fini()
...
/// Create array of srv/VacuumSet messages.
/**
 * It allocates the memory for the array and calls
 * vg_control_interfaces__srv__VacuumSet_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/VacuumSet messages.
/**
 * It calls
 * vg_control_interfaces__srv__VacuumSet_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/VacuumSet message array equality.
/**
...
/// Copy an array of srv/VacuumSet messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vg_control_interfaces__srv__VacuumSet_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vg_control_interfaces
...
/**
 * It calls
 * vg_control_interfaces__srv__VacuumSet_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vg_control_interfaces
...
/**
 * It allocates the memory for the array and calls
 * vg_control_interfaces__srv__VacuumSet_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vg_control_interfaces
...
/**
 * It calls
 * vg_control_interfaces__srv__VacuumSet_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VG_CONTROL_INTERFACES__SRV__DETAIL__VACUUM_SET__FUNCTIONS_H_
